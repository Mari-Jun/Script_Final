...
#unix 시간을 날짜만 있게 바꾼다.
cg_unix_md = lambda ts: (datetime.datetime.fromtimestamp(ts) - datetime.timedelta(hours=2)).strftime('%m-%d')
#Sunday, Monday....
cg_unix_d = lambda ts: (datetime.datetime.fromtimestamp(ts) - datetime.timedelta(hours=2)).strftime('%A')
